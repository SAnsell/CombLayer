...
\begin{description}
\item[-defaultConfig Single NMX -angle free 60] These optional arguments build the NMX beam line and rotate geometry around the $z$ axis
  in such a way that the NMX beam line is oriented along the $x$ axis.
  This rotation simplifies the weight window setup for the current example. 
