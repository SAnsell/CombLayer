...
\item[--wwgEnergy] defines a mesh. Format: EnergyName [energy boundaries]
  \begin{description}
    \item E1 E2 E3 .... these are the energy bin boundaries. The minimum is 2.
  \end{description}
\item[--wwgMesh] defines a mesh.
  \begin{description}
  ...
  \end{description}
  Note that each Vec3D point can be a generalized FixedComp linkPonit, or
  a PointMap value.
