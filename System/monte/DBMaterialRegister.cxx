...
// Material #38 Solid Pure Tungsten (0.063057)
  ...
  // Density = 2.33 g/cm3
  /*
 // Weight fractions might work incorrect 
    MObj.setMaterial(144,"LimestoneConcrete",
		   " 01001.70c -0.00723 "
		   " 08016.70c -0.6372 "
		   " 13027.70c -0.0099 "
		   " 14028.70c -0.0435 "
	    ...
	    //	   " 37000.70c -0.004 " //Rb cross sections are  missing in FLUKA
		   ...
		   " 40091.70c -0.000105 "
		   " 82207.70c -0.000009 "
		   " 41093.70c -0.000009 ", "lwtr.10t", MLib);
    */
  ...
  MObj.setMaterial(145, "MagnadenseHC",
  ...
  //Number atom fractions
  MObj.setMaterial(146,"BorkronNBK7", //Optical Materials Express, Vol. 3 No1 P.69, 1 January 2013
  ...
  //Number atom fractions
  MObj.setMaterial(147,"B4CConcrete", //JLab composition from Tsito
  ...
  setMaterial(MObj);
    ...
    MObj.setMaterial(148,"PVC", //(C2H3Cl)n 
		   " 01000.70c      3 " //H
		   " 06000.70c      2 "//C12
		   " 17000.70c       1 "//Cl
		   , "lwtr.10t", MLib);
  ...
  MObj.setMaterial(150,"Mirrobor", //B4C rubber from Mirrotron
		   " 01000.70c      0.01" //H
		   " 05000.70c       0.05797"//B
		   " 06000.70c       0.07246"//C
  ...
  MObj.setMaterial(151,"SteelS355", //S355 steeel from Valentina
  ...
  setMaterial(MObj);
    ...
    MObj.setMaterial(152,"Lead51121", //B4C rubber from Mirrotron
 ...
 MObj.setMaterial(153,"Nimonic75", //B4C rubber from Mirrotron
		"  6000.70c 0.0125  "//C
