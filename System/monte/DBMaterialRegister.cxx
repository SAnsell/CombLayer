...
// Material #38 Solid Pure Tungsten (0.063057)
  ...
  MObj.setMaterial(153,"MARS_STST",
		   "24050.70c  8.780690E-03  "
		   "24052.70c  1.693270E-01  "
		   "24053.70c  1.920030E-02  "
		   "24054.70c  4.779370E-03  "
		   "25055.70c  2.013320E-02  "
		   "26054.70c  4.022910E-02  "
		   "26056.70c  6.315110E-01  "
		   "26057.70c  1.458430E-02  "
		   "26058.70c  1.940910E-03  "
		   "28058.70c  6.093840E-02  "
		   "28060.70c  2.347340E-02  "
		   "28061.70c  1.020370E-03  "
		   "28062.70c  3.253390E-03  "
		   "28064.70c  8.285420E-04","",MLib);
  MObj.setDensity(-7.92);
  setMaterial(MObj);

  MObj.setMaterial(154,"MARS_QXYOKE",
		  "26054.70c 5.528820E-02 "
		  "26056.70c 8.679070E-01 "
		  "26057.70c 2.004380E-02 "
		  "26058.70c 2.667460E-03 "
		  "6012.70c 1.343240E-04 "
		  "6013.70c 1.504710E-06 "
		  "25055.70c 1.484810E-03 "
		  "15031.70c 1.755740E-04 "
		  "16032.70c 1.611930E-05 "
		  "16033.70c 1.269810E-07 "
		  "16034.70c 7.116590E-07 "
		  "16036.70c 2.472830E-09 "
		  "14028.70c 4.821780E-02 "
		  "14029.70c 2.448360E-03 "
		  "14030.70c 1.613970E-03 ","",MLib);
  MObj.setDensity(-7.65);
  setMaterial(MObj);
  
  MObj.setMaterial(155,"MARS_QXCOIL",
		  "29063.70c  6.914880E-01  "
		  "29065.70c  3.084950E-01  "
		  "83209.70c  1.520440E-06  "
		  "82204.70c  2.146730E-07  "
		  "82206.70c  3.695450E-06  "
		  "82207.70c  3.388770E-06  "
		  "82208.70c  8.034910E-06  ","",MLib);
 MObj.setDensity(-8.94);
 setMaterial(MObj);

 //S355 recipe from materials handbook. Impurities divided by two. Fill3 for FEB, 90% density
  MObj.setMaterial(156, "S355_SteelFill3",
		   "6012.70c 0.0052616  "
		   "6013.70c 5.8941e-05  "
		   "25055.70c 0.00809204  "
		   "15031.70c 0.000448526  "
		   "16036.70c 6.31717e-08  "
		   "16033.70c 3.2439e-06  "
		   "16032.70c 0.000411789  "
		   "16034.70c 1.81802e-05  "
		   "14029.70c 2.31654e-05  "
		   "14030.70c 1.52707e-05  "
		   "14028.70c 0.000456217  "
		   "27059.70c 0.000235734  "
		   "26058.70c 0.00277763  "
		   "26057.70c 0.0208716  "
		   "26054.70c 0.0575718  "
		   "26056.70c 0.903754  ","",MLib);
  MObj.setDensity(-7.85*0.9);
  setMaterial(MObj);

    //Revised and reduced clay recipe from materials handbook
  MObj.setMaterial(157, "ClayRevised",
		   "1001.70c 2.7385823E-01  "
		   "1002.70c 4.2657354E-05  "
		   "13027.70c 1.9129326E-02  "
		   "20040.70c 1.2510391E-02  "
		   "20042.70c 8.3496361E-05  "
		   "20043.70c 1.7421977E-05  "
		   "20044.70c 2.6920194E-04  "
		   "20046.70c 5.1620553E-07  "
		   "20048.70c 2.4132693E-05  "
		   "26054.70c 2.8016989E-04  "
		   "26056.70c 4.3980627E-03  "
		   "26057.70c 1.0157037E-04  "
		   "26058.70c 1.3517196E-05  "
		   "19039.70c 6.2179974E-03  "
		   "19040.70c 7.8009953E-07  "
		   "19041.70c 4.4873733E-04  "
		   "12024.70c 2.9404146E-03  "
		   "12025.70c 3.7318047E-04  "
		   "12026.70c 4.1075854E-04  "
		   "11023.70c 3.1594024E-03  "
		   "16032.70c 5.5766405E-04  "
		   "16033.70c 4.3930440E-06  "
		   "16034.70c 2.4620599E-05  "
		   "16036.70c 8.5550147E-08  "
		   "22046.70c 7.7876550E-05  "
		   "22047.70c 7.0230607E-05  "
		   "22048.70c 6.9588687E-04  "
		   "22049.70c 5.1068122E-05  "
		   "22050.70c 4.8897065E-05  "
		   "14028.70c 1.9598411E-01  "
		   "14029.70c 9.9515049E-03  "
		   "14030.70c 6.5600818E-03  "
		   "8016.70c 4.6059506E-01  "
		   "8017.70c 1.7498152E-04  "
		   "8018.70c 9.2357139E-04  ","",MLib);
  MObj.setDensity(-2.0);
  setMaterial(MObj);

  // Reference: material StbTCABL in MARS
  // Reduced density 50%
  MObj.setMaterial(158,"StbTCABL_TOP",
		   " 1001.70c  3.88760701228E-01 "
		   " 1002.70c  4.47126239451E-05 "
		   ...
		   " 29063.70c 1.46695727581E-01 "
		   " 29065.70c 6.53842615705E-02 ","",MLib);
  MObj.setDensity(-1.45);
  setMaterial(MObj);
  
  // Reference: material StbTCABL in MARS
  // Reduced density by 0.3
  MObj.setMaterial(159,"StbTCABL_BOT",
		   " 1001.70c  3.88760701228E-01 "
		   " 1002.70c  4.47126239451E-05 "
		   " 6012.70c  2.63615249316E-01 "
		   " 6013.70c  2.85119090550E-03 "
