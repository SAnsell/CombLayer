...
MObj.setMaterial(imat++/*2660*/, "Invar36",
 ...
 MDB.resetMaterial(MObj);
  ...
  // Clay Till Lera
  // same as material ClayTillLera in MATER.INP in MARS
  // mass fractions converted into atomic fractions by table 40
  MObj.setMaterial(imat++, "ClayTillLera",
		   " 1001.70c 2.90592205168E-01 "
		   " 8016.70c 5.02320173444E-01 "
		   " 12024.70c 4.40514027448E-03 "
		   " 13027.70c 2.71704413909E-02 "
		   " 14028.70c 8.97667175543E-02 "
		   " 19039.70c 1.04295748903E-03 "
		   " 20040.70c 1.16738772449E-02 "
		   " 22048.70c 5.56999001862E-02 "
		   " 25055.70c 2.36702938088E-03 "
		   " 26056.70c 2.03423792431E-04 "
		   " 37085.70c 1.46638374689E-02 "
		   " 56138.70c 9.42966055301E-05 ",
  ...
  MObj.setMaterial(imat++,"StbTCABL",
		   " 1001.70c 3.87320576137E-01 "
		   " 06000.70c 2.65411684969E-01 "
		   " 17035.70c 1.33953964738E-01 "
		   " 29063.70c 2.13313774157E-01 ","",MLib);
