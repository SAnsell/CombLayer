...
namespace RefCon
{
  const double c(299792458.0);               ///< Speed of light [m/sec^2]
  const double c2(8.987551787e16);            ///< Speed of light^2 [m^2/sec^4]
  const double e2(2.567010233e-38);           ///< electron charge^2  
  const double me(9.109534e-31);              ///< Mass of electron (kg)
  const double hc_e(1.239852066e-2);          ///< convertion in MeV to angstrom (wavelength)
  const double reyb(13.60569172);             ///< Reyberg Constant
  const double pi(3.14159265359);             ///< Pi
  const double re(2.817940285e-15);           ///< electron Radius [m]
