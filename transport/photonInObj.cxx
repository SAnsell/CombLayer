...
double 
photonInObj::getRefractive(const MonteCarlo::particle& N) const
  /*!
...
template<>
int
photonInObj<MonteCarlo::neutron>::trackWeight
(MonteCarlo::neutron& N,double& R,const Geometry::Surface*& surfPtr) const
  ...
  */
{
  ELog::RegMethod RegA("photonInObj<neutron>","trackWeight");
...
template<>
int
photonInObj<MonteCarlo::neutron>::trackAttn(MonteCarlo::neutron& N,
  ...
  */
{
  ELog::RegMethod RegA("photonInObj","trackAttn");
  double aDist(0);
