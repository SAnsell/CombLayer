...
#declare cameraNumber = 0; // 0: DTL global view;  1: beam dump view
#declare lightSource  = 1; // 0: only the beam dump bulb; 1: simple array of point lights; 2: array of area_light
