...
void
XRayHutchBaseGenerator::setFrontPlate(const double T, const double W, const double H)
/*!
  Set front wall plate
  \param T :: thickness
  \param W :: width
  \param H :: full height
 */
{
  frontPlateActive = true;
  frontPlateThick  = T;
  frontPlateWidth  = W;
  frontPlateHeight = H;
}
  ...
  */
{
  ...
  Control.addVariable(keyName+"FrontPlateActive",frontPlateActive);
