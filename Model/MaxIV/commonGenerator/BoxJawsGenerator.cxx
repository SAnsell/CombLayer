...
BoxJawsGenerator::BoxJawsGenerator() :
  width(19.3),height(19.3),
  length(15.8),sideThick(1.5),
  wallThick(1.5),
...
void
BoxJawsGenerator::generateJaws(FuncDataBase& Control,
  ...
  */
{
  ELog::RegMethod RegA("BoxJawsGenerator","generateBoxJaws");
...
template void BoxJawsGenerator::setPortCF<CF40>();
