 ...
 * File:   commonGenerator/MagnetN1Generator.cxx
 *
...
#include "MagnetN1Generator.h"

namespace setVariable
{

MagnetN1Generator::MagnetN1Generator() :
...
void
MagnetN1Generator::generateEntryPipe(FuncDataBase& Control,
   ...
   */
{
  ELog::RegMethod RegA("MagnetN1Generator","generateEntryPipe");
...
void
MagnetN1Generator::generateHalfPipe(FuncDataBase& Control,
				    const std::string& pipeName) const
  /*!
    Half Pipe
    \param Control :: dataBase
   ...
   */
{
  ELog::RegMethod RegA("MagnetN1Generator","generateHalfPipe");
...
void
MagnetN1Generator::generateBlock(FuncDataBase& Control,
  ...
  */
{
  ELog::RegMethod RegA("MagnetN1Generator","generateBlock");
