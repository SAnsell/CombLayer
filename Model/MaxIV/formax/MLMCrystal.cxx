  ...
  */
{
  ...
  FixedComp::setConnect("BeamCentre",Origin,-X);
  FixedComp::setLinkSurf("BeamCentre",-SMap.realSurf(buildIndex+3));

  FixedComp::setConnect("3",Origin+X*width,X);
  FixedComp::setLinkSurf("3",SMap.realSurf(buildIndex+4));

  FixedComp::setConnect("BaseRotPt",Origin-Z*(height/2.0+baseDepth),-Z);
  FixedComp::setLinkSurf("BaseRotPt",SMap.realSurf(buildIndex+105));

  FixedComp::setConnect("5",Origin+Z*(height/2.0),Z);
  FixedComp::setLinkSurf("5",SMap.realSurf(buildIndex+6));

  // shifted base point but keeping normal orientation
  FixedComp::setConnect("BasePt",Origin-Z*(height/2.0+baseDepth),Y);
  FixedComp::setLinkSurf("BasePt",SMap.realSurf(buildIndex+105));
