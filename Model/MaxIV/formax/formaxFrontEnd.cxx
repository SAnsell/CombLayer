...
void
formaxFrontEnd::populate(const FuncDataBase& Control)
  /*!
...
void
formaxFrontEnd::createUnitVector(const attachSystem::FixedComp& FC,
  ...
  */
{
  ELog::RegMethod RegA("formaxFrontEnd","createUnitVector");
...
void
formaxFrontEnd::createSurfaces()
  /*!
    Create surfaces
  */
{
  ELog::RegMethod RegA("formaxFrontEnd","createSurfaces");
...
void
formaxFrontEnd::insertFlanges(Simulation& System,
   ...
   */
{
  ELog::RegMethod RegA("formaxFrontEnd","insertFlanges");
...
void
formaxFrontEnd::buildHeatTable(Simulation& System,
  ...
  */
{
  ELog::RegMethod RegA("formaxFrontEnd","buildHeatTable");
...
void
formaxFrontEnd::buildApertureTable(Simulation& System,
				   MonteCarlo::Object* masterCell,
				   const attachSystem::FixedComp& preFC,
				   const long int preSideIndex)
...
void
formaxFrontEnd::buildShutterTable(Simulation& System,
				   MonteCarlo::Object* masterCell,
				   const attachSystem::FixedComp& preFC,
				   const long int preSideIndex)
  /*!
...
void
formaxFrontEnd::buildObjects(Simulation& System)
  /*!
  ...
  */
{
  ELog::RegMethod RegA("formaxFrontEnd","buildObjects");
...
void 
formaxFrontEnd::createAll(Simulation& System,
...
{
  // For output stream
  ELog::RegMethod RControl("formaxFrontEnd","build");
