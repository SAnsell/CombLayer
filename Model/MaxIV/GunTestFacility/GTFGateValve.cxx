...
GTFGateValve::GTFGateValve(const GTFGateValve& A) :
  ...
  bladeOutCutThick(A.bladeOutCutThick),
  bladeOutCutRadius(A.bladeOutCutRadius),
  ...
  */
{
  ...
  bladeOutCutThick=Control.EvalVar<double>(keyName+"BladeOutCutThick");
  bladeOutCutRadius=Control.EvalVar<double>(keyName+"BladeOutCutRadius");
  ...
  lsShaftWindowThick=Control.EvalVar<double>(keyName+"LSShaftWindowThick");
  ...
  lsShaftWindowMat=ModelSupport::EvalMat<int>(Control,keyName+"LSShaftWindowMat");
  ...
  */
{
  ...
  ModelSupport::buildShiftedPlane(SMap,buildIndex+535,buildIndex+516,Z,-lsShaftWindowThick);
  ...
  */
{
  ...
  HR=ModelSupport::getHeadRule(SMap,buildIndex,"311 -341 317 -307");
  makeCell("Blade",System,cellIndex++,bladeMat,0.0,HR);

  HR=ModelSupport::getHeadRule(SMap,buildIndex,"341 -331 317 -357");
  makeCell("Blade",System,cellIndex++,bladeMat,0.0,HR);

  HR=ModelSupport::getHeadRule(SMap,buildIndex,"341 -331 357 -307");
  ...
  HR=ModelSupport::getHeadRule(SMap,buildIndex,"-517 506 -535");
  makeCell("LSShaftVoidInner",System,cellIndex++,voidMat,0.0,HR);

  HR=ModelSupport::getHeadRule(SMap,buildIndex,"-517 535 -516");
  makeCell("LSShaftWindow",System,cellIndex++,lsShaftWindowMat,0.0,HR);
