  ...
  */
{
  ...
  maxivConstruct::pipeMagUnit(System,buildZone,pipeA,
			       "#front","outerPipe",solenoid);
  ...
  outerCell1=
    constructSystem::constructUnit(System,buildZone,*pipeA,"back",*gate);
  ...
  ELog::EM << "TODO: skipping two objects: "
	   <<"~screen chamber and coils - must be added" << ELog::endWARN;
