 ...
 * File:   tomowiseInc/tomowiseOpticsLine.h
 *
 ...
 *
 ****************************************************************************/
#ifndef xraySystem_tomowiseOpticsLine_h
#define xraySystem_tomowiseOpticsLine_h
...
namespace xraySystem
{
  ...
  /*!
    ...
    \author K. Batkov
    \date February 2025
    \brief TomoWISE optics beamline
  */
  ...
  public attachSystem::CellMap
{
 ...
 public:
  ...
  tomowiseOpticsLine(const std::string&);
  tomowiseOpticsLine(const tomowiseOpticsLine&);
  tomowiseOpticsLine& operator=(const tomowiseOpticsLine&);
  ~tomowiseOpticsLine() override;
