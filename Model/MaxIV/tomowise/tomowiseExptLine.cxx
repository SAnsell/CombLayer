...
tomowiseExptLine::tomowiseExptLine(const std::string& Key) :
...
void
tomowiseExptLine::populate(const FuncDataBase& Control)
  /*!
    Populate the intial values [movement]
    \param Control :: Database
   */
{
  ELog::RegMethod RegA("tomowiseExptLine","populate");
...
void
tomowiseExptLine::createSurfaces()
  /*!
    Create surfaces for outer void
  */
{
  ELog::RegMethod RegA("tomowiseExptLine","createSurface");
...
void
tomowiseExptLine::buildObjects(Simulation& System)
  /*!
  ...
  */
{
  ELog::RegMethod RegA("tomowiseExptLine","buildObjects");
...
void
tomowiseExptLine::createLinks()
  /*!
    Create a front/back link
   */
{
  ELog::RegMethod RControl("tomowiseExptLine","createLinks");
...
void
tomowiseExptLine::insertSample(Simulation& System,
   ...
   */
{
  ELog::RegMethod RegA("tomowiseExptLine","insertSample");
...
void
tomowiseExptLine::createAll(Simulation& System,
...
/*!
  ...
  */
{
  ELog::RegMethod RControl("tomowiseExptLine","createAll");
