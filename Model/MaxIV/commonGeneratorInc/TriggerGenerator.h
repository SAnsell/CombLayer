 ...
 *
 ****************************************************************************/
#ifndef setVariable_TriggerGenerator_h
#define setVariable_TriggerGenerator_h
...
/*!
  ...
  \author S. Ansell
  \date April 2020
  \brief TriggerGenerator for variables
*/
...
class TriggerGenerator 
{
 ...
 public:
  ...
  TriggerGenerator();
  TriggerGenerator(const TriggerGenerator&);
  TriggerGenerator& operator=(const TriggerGenerator&);
