  ...
  */
{
  ...
  yokeRadius=Control.EvalTail<double>(keyName,baseName,"YokeRadius");
  yokeOuter=Control.EvalTail<double>(keyName,baseName,"YokeOuter");
  ...
  */
{
  ...
  for(size_t i=0;i < 2*NPole; i++)
    {
      ...
      // Yoke Items:
      ModelSupport::buildPlane(SMap,CN+1,Origin+QR*yokeRadius,QR);
  ...
  // Outer yoke
  ModelSupport::buildPlane(SMap,buildIndex+3,Origin-X*yokeOuter,X);
  ModelSupport::buildPlane(SMap,buildIndex+4,Origin+X*yokeOuter,X);
  ModelSupport::buildPlane(SMap,buildIndex+5,Origin-Z*yokeOuter,Z);
  ModelSupport::buildPlane(SMap,buildIndex+6,Origin+Z*yokeOuter,Z);
  ...
  for(size_t i=0; i<NPole;i++)
    {
      ...
      HR=ModelSupport::getHeadRule(SMap,PN,"2203 -2204 (-2207 : 2201)");
      makeCell("Pole",System,cellIndex++,poleMat,0.0,HR*outerCut*fbHR);
      HR=ModelSupport::getHeadRule(SMap,PN,"2203 -2204 -2207");      
	...
	(SMap,PN,"2003 -2004 2001 2013 2014 2017 2018 (-2203:2204)");
      ...
      HR=ModelSupport::getHeadRule
	(SMap,PN," 2003 -2004 2013 2014 2017 2018");
