...
Segment42::Segment42(const std::string& Key) :
  TDCsegment(Key,2),
...
void
Segment42::buildObjects(Simulation& System)
  /*!
...
void
Segment42::createLinks()
  /*!
    Create a front/back link
   */
{
  ELog::RegMethod RegA("Segment42","createLinks");

  setLinkCopy("front",*uVac,1);
  setLinkCopy("back",*uVac,2);
...
{
  // For output stream
  ELog::RegMethod RControl("Segment42","build");
