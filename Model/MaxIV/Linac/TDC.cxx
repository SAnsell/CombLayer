...
namespace tdcSystem
{
  ...
  */
  ...
  void TDC::buildDetectors(Simulation& System)
  /*!
    Build radiation detectors
  */
  {
    for (size_t i=0; i<nWendi; ++i) {
    ...
    for (size_t i=0; i<nIon; ++i) {
      if (i==2)
	cell="TVoidA"; // SPF hall
      else if ((i==4) || (i==7) || (i==8))
	cell="KlystronVoid1"; // FKG
      else if (i==9)
	cell="KlystronVoid3"; // FKG upstream BTG
      else if (i==5)
