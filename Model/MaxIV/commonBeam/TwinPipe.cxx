  ...
  */
{
  ...
  FixedComp::setConnect("pipeAOuterLeft",APipe-AXAxis*ARadius,-AXAxis);
  FixedComp::setConnect("pipeAOuterRight",APipe+AXAxis*ARadius,AXAxis);
  FixedComp::setConnect("pipeAOuterBase",APipe-Z*ARadius,-Z);
  FixedComp::setConnect("pipeAOuterTop",APipe+Z*ARadius,Z);


  FixedComp::setLinkSurf("pipeAOuterLeft",SMap.realSurf(buildIndex+117));
  FixedComp::setLinkSurf("pipeAOuterRight",SMap.realSurf(buildIndex+117));
  FixedComp::setLinkSurf("pipeAOuterBase",SMap.realSurf(buildIndex+117));
  FixedComp::setLinkSurf("pipeAOuterTop",SMap.realSurf(buildIndex+117));

  const Geometry::Vec3D BPipe(ACent+BYAxis*(pipeBLength/2.0));
  const double BRadius(pipeBRadius+pipeBThick);
  FixedComp::setConnect("pipeBOuterLeft",BPipe-BXAxis*BRadius,-BXAxis);
  FixedComp::setConnect("pipeBOuterRight",BPipe+BXAxis*BRadius,BXAxis);
  FixedComp::setConnect("pipeBOuterBase",BPipe-Z*BRadius,-Z);
  FixedComp::setConnect("pipeBOuterTop",BPipe+Z*BRadius,Z);


  FixedComp::setLinkSurf("pipeBOuterLeft",SMap.realSurf(buildIndex+217));
  FixedComp::setLinkSurf("pipeBOuterRight",SMap.realSurf(buildIndex+217));
  FixedComp::setLinkSurf("pipeBOuterBase",SMap.realSurf(buildIndex+217));
  FixedComp::setLinkSurf("pipeBOuterTop",SMap.realSurf(buildIndex+217));
