 ...
 * File:   Model/MaxIV/commonBeam/CooledScreen2.cxx
 *
 * Copyright (c) 2004-2026 Stuart Ansell
 *
...
#include "CooledScreen2.h"

namespace xraySystem
{

CooledScreen2::CooledScreen2(const std::string& Key)  :
...
void
CooledScreen2::calcImpactVector()
  /*!
  ...
  */
{
  ELog::RegMethod RegA("CooledScreen2","calcImpactVector");
...
void
CooledScreen2::populate(const FuncDataBase& Control)
  /*!
    Populate all the variables
    \param Control :: Variable data base
  */
{
  ELog::RegMethod RegA("CooledScreen2","populate");
...
void
CooledScreen2::createSurfaces()
  /*!
    Create All the surfaces
  */
{
  ELog::RegMethod RegA("CooledScreen2","createSurfaces");
...
void
CooledScreen2::createObjects(Simulation& System)
  /*!
    Adds the all the components
    \param System :: Simulation to create objects in
  */
{
  ELog::RegMethod RegA("CooledScreen2","createObjects");
  ...
  if (inBeam)
    {
      ...
      // makeCell("CooledScreen2",System,cellIndex++,screenMat,0.0,HR);
...
void
CooledScreen2::createLinks()
  /*!
    Create all the linkes [need front/back to join/use InnerZone]
  */
{
  ELog::RegMethod RegA("CooledScreen2","createLinks");

  return;
}

void
CooledScreen2::setBeamAxis(const attachSystem::FixedComp& FC,
  ...
  */
{
  ELog::RegMethod RegA("CooledScreen2","setBeamAxis(FC)");
...
void
CooledScreen2::setBeamAxis(const Geometry::Vec3D& Org,
  ...
  */
{
  ELog::RegMethod RegA("CooledScreen2","setBeamAxis(Vec3D)");
...
void
CooledScreen2::createAll(Simulation& System,
  ...
  */
{
  ELog::RegMethod RegA("CooledScreen2","createAll");
