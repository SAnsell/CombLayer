 ...
 *
 ****************************************************************************/
#ifndef xraySystem_MagnetN1_h
#define xraySystem_MagnetN1_h
...
/// Octupole [first]
 ...
 public:
  ...
  MagnetN1(const std::string&);
  MagnetN1(const MagnetN1&);
  MagnetN1& operator=(const MagnetN1&);
  virtual ~MagnetN1();
