  ...
  */
{
  ...
  Control.addVariable(frontKey+"PermanentMagnetYStep",102.25); // email from AR 251110: 13.1 m from the straight section center for TomoWISE conceptual design (does not match [3]). Position depends on beamline.
