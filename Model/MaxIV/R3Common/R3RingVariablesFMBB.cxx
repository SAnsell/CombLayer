...
namespace setVariable
{
  ...
  void moveApertureTableFMBB(FuncDataBase&,const std::string&);
  void R3FrontEndFMBBVariables(FuncDataBase& Control, const std::string& beamlineKey);
  ...
  */
{
  ...
  CrossGen.generateDoubleCF<setVariable::CF63,setVariable::CF100>
    (Control,frontKey+"IonPump4",52.0,15.74,28.70);   // height/depth
