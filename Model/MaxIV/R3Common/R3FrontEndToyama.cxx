  ...
  */
{
  ...
  constructSystem::constructUnit
    (System,buildZone,*bellowE,"back",*aperturePipeA);
  ...
  constructSystem::constructUnit(System,buildZone,*bellowF,"back",*ionPC);
  constructSystem::constructUnit(System,buildZone,*ionPC,"back",*bellowG);
  ...
  */
{
  ...
  maxivConstruct::pipeMagUnit(System,buildZone,collABPipe,"#front","outerPipe",pMag);
  maxivConstruct::pipeTerminate(System,buildZone,collABPipe);
