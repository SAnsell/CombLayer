  ...
  public attachSystem::FixedOffset
{
 private:
  ...
  double frontWallLength;       ///< length (vol 6 in SPLTDISH0001)
  double frontWallHeight;       ///< height
  double frontWallDepth;        ///< depth 
  double frontWallWidth;        ///< width 
  double frontWallHoleRad;      ///< Front wall hole  radius

  double backWallLength;        ///< Back wall length (+y, vol 6 in SPLTDISH0001)
  double backWallDepth;         ///< Back wall depth 
