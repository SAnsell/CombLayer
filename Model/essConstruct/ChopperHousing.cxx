  ...
  */
{
  ...
  FixedComp::setConnect("front",Origin-Y*(voidThick/2.0+wallThick),-Y);
  FixedComp::setConnect("back",Origin+Y*(voidThick/2.0+wallThick),Y);
  FixedComp::setConnect("left",Origin-X*(voidWidth/2.0+wallThick),-X);
  FixedComp::setConnect("right",Origin+X*(voidWidth/2.0+wallThick),X);
  FixedComp::setConnect("base",Origin-Y*(voidDepth+wallThick),-Z);
  FixedComp::setConnect("top",Origin-Y*(voidHeight+wallThick),Z);
