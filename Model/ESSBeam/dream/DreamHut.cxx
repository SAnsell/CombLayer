...
DreamHut::DreamHut(const std::string& Key) : 
...
void
DreamHut::populate(const FuncDataBase& Control)
  /*!
    Populate all the variables
    \param Control :: DataBase of variables
  */
{
  ELog::RegMethod RegA("DreamHut","populate");
...
void
DreamHut::createUnitVector(const attachSystem::FixedComp& FC,
...
void
DreamHut::createSurfaces()
  /*!
    Create the surfaces
  */
{
  ELog::RegMethod RegA("DreamHut","createSurfaces");
...
void
DreamHut::createObjects(Simulation& System)
  /*!
    Adds the main objects
    \param System :: Simulation to create objects in
   */
{
  ELog::RegMethod RegA("DreamHut","createObjects");
...
void
DreamHut::createLinks()
  /*!
    Determines the link point on the outgoing plane.
    It must follow the beamline, but exit at the plane
  */
{
  ELog::RegMethod RegA("DreamHut","createLinks");
...
void
DreamHut::createAll(Simulation& System,
  ...
  */
{
  ELog::RegMethod RegA("DreamHut","createAll(FC)");
