 ...
 * File:   essConstruct/SimpleBoxChopper.cxx
 *
...
SimpleBoxChopper::SimpleBoxChopper(const std::string& Key) : 
...
SimpleBoxChopper::SimpleBoxChopper(const SimpleBoxChopper& A) : 
  ...
  /*!
    Copy constructor
    \param A :: SimpleBoxChopper to copy
  */
{}

SimpleBoxChopper&
SimpleBoxChopper::operator=(const SimpleBoxChopper& A)
  /*!
    Assignment operator
    \param A :: SimpleBoxChopper to copy
    \return *this
...
SimpleBoxChopper::~SimpleBoxChopper() 
  /*!
    Destructor
  */
{}
...
void
SimpleBoxChopper::populate(const FuncDataBase& Control)
  /*!
    Populate all the variables
    \param Control :: DataBase of variables
  */
{
  ELog::RegMethod RegA("SimpleBoxChopper","populate");
...
void
SimpleBoxChopper::createUnitVector(const attachSystem::FixedComp& FC,
  ...
  */
{
  ELog::RegMethod RegA("SimpleBoxChopper","createUnitVector");
...
void
SimpleBoxChopper::createSurfaces()
  /*!
    Create the surfaces
  */
{
  ELog::RegMethod RegA("SimpleBoxChopper","createSurfaces");
...
void
SimpleBoxChopper::createObjects(Simulation& System)
  /*!
    Adds the vacuum box
    \param System :: Simulation to create objects in
  */
{
  ELog::RegMethod RegA("SimpleBoxChopper","createObjects");
...
void
SimpleBoxChopper::createLinks()
  /*!
    Determines the link point on the outgoing plane.
    It must follow the beamline, but exit at the plane
  */
{
  ELog::RegMethod RegA("SimpleBoxChopper","createLinks");
...
void
SimpleBoxChopper::insertAxle(Simulation& System,
  ...
  */
{
  ELog::RegMethod RegA("SimpleBoxChopper","insertAxle");
...
void
SimpleBoxChopper::createMotor(Simulation& System)
  /*!
    Create the motor
    \param System :: Simulation to use
  */
{
  ELog::RegMethod RegA("SimpleBoxChopper","procMotor");
...
void
SimpleBoxChopper::createAll(Simulation& System,
  ...
  */
{
  ELog::RegMethod RegA("SimpleBoxChopper","createAll(FC)");
