 ...
 *
 ****************************************************************************/
#ifndef constructSystem_CaveMicoBlock_h
#define constructSystem_CaveMicoBlock_h
  ...
  public attachSystem::CellMap
{
 private:
  ...
  double l1edge,l1mid,gap,gapWave,l2edge,l2mid;  ///< top level length before and after gap
 ...
 public:
  ...
  CaveMicoBlock(const std::string&);
  CaveMicoBlock(const CaveMicoBlock&);
  CaveMicoBlock& operator=(const CaveMicoBlock&);
  virtual ~CaveMicoBlock();
