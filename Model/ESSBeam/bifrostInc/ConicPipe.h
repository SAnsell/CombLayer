 ...
 *
 ****************************************************************************/
#ifndef constructSystem_ConicPipe_h
#define constructSystem_ConicPipe_h
  ...
  public attachSystem::FrontBackCut
{
 ...
 public:
  ...
  ConicPipe(const std::string&);
  ConicPipe(const ConicPipe&);
  ConicPipe& operator=(const ConicPipe&);
  virtual ~ConicPipe();
