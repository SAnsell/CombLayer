 ...
 * File:   Model/caveBuildInc/Beamstop.h
 *
 ...
 *
 ****************************************************************************/
#ifndef constructSystem_Beamstop_h
#define constructSystem_Beamstop_h
  ...
  public attachSystem::CellMap
{
 private:
  ...
  int voidMat;               //> material inside shielding
  int B4CMat;                    ///Material for B4Ctiles inside and outside
  int iFrontLining;   // if it is needed to have front lining in the void
