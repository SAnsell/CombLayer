 ...
 *
 ****************************************************************************/
#ifndef constructSystem_LineShieldPlus_h
#define constructSystem_LineShieldPlus_h
  ...
  public attachSystem::CellMap
{
 private:
  ...
  double FinalThick;        // Thickness of the outermost layer
   
  int defMat;                    ///< Fe material layer
  int voidMat;                    ///< Fe material layer
 ...
 public:
  ...
  LineShieldPlus(const std::string&);
  LineShieldPlus(const LineShieldPlus&);
  LineShieldPlus& operator=(const LineShieldPlus&);
  virtual ~LineShieldPlus();
