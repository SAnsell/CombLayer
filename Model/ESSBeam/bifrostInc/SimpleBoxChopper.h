 ...
 * File:   essConstructInc/SimpleBoxChopper.h
 *
 ...
 *
 ****************************************************************************/
#ifndef constructSystem_SimpleBoxChopper_h
#define constructSystem_SimpleBoxChopper_h
  ...
  public attachSystem::SurfMap
{
 ...
 public:
  ...
  SimpleBoxChopper(const std::string&);
  SimpleBoxChopper(const SimpleBoxChopper&);
  SimpleBoxChopper& operator=(const SimpleBoxChopper&);
  virtual ~SimpleBoxChopper();
