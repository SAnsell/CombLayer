 ...
 * File:   commonVarInc/TwinGeneratorU.h
 *
 ...
 *
 ****************************************************************************/
#ifndef essSystem_TwinGeneratorU_h
#define essSystem_TwinGeneratorU_h
...
/*!
  \class TwinGeneratorU
  \version 1.0
  \author S. Ansell
  \date May 2016
  \brief TwinGeneratorU for variables
*/
...
class TwinGeneratorU
{
 ...
 public:
  ...
  TwinGeneratorU();
  TwinGeneratorU(const TwinGeneratorU&);
  TwinGeneratorU& operator=(const TwinGeneratorU&);
  ~TwinGeneratorU();
