...
teaSet::teaSet(const std::string& Key) :
...
teaSet::teaSet(const teaSet& A) : 
  ...
  /*!
    Copy constructor
    \param A :: teaSet to copy
  */
{}

teaSet&
teaSet::operator=(const teaSet& A)
  /*!
    Assignment operator
    \param A :: teaSet to copy
    \return *this
...
void
teaSet::populate(const FuncDataBase& Control)
  /*!
    Populate all the variables
    \param Control :: Variable table to use
  */
{
  ELog::RegMethod RegA("teaSet","populate");
...
void
teaSet::createUnitVector(const attachSystem::FixedComp& FC,
  ...
  */
{
  ELog::RegMethod RegA("teaSet","createUnitVector");
...
void
teaSet::createSurfaces()
  /*!
    Create planes for system
  */
{
  ELog::RegMethod RegA("teaSet","createSurfaces");
...
void
teaSet::createObjects(Simulation& System)
  /*!
    Create the vaned moderator
    \param System :: Simulation to add results
  */
{
  ELog::RegMethod RegA("teaSet","createObjects");
...
teaSet::createLinks()
  ...
  */
{  
  ELog::RegMethod RegA("teaSet","createLinks");
...
void 
teaSet::layerProcess(Simulation& System)
  /*!
    Processes the splitting of the surfaces into a multilayer system
    \param System :: Simulation to work on
  */
{
  ELog::RegMethod RegA("teaSet","layerProcess");
  // Steel layers
  //  layerSpecial(System);
...
void
teaSet::createAll(Simulation& System,
   ...
   */
{
  ELog::RegMethod RegA("teaSet","createAll");
