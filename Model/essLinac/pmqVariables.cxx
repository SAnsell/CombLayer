  ...
  */
{
  ...
  Control.addVariable("LinacDTL5PMQ11Length",8); //Changed after discussion with Mamad
  Control.addVariable("LinacDTL5PMQ11GapLength",58);
  Control.addVariable("LinacDTL5PMQ12Length",8); //Changed after discussion with Mamad
