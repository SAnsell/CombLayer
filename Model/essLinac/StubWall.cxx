...
StubWall::StubWall(const std::string& baseKey,
  ...
  */
{
  ...
  ModelSupport::buildPlane(SMap,buildIndex+2,Origin+Y*(width),Y);
...
void
StubWall::createObjects(Simulation& System)
  /*!
  ...
  */
{
  ...
  makeCell("wall",System,cellIndex++,mat,0.0,HR*floorHR);
  ...
  */
{
  ...
  ELog::EM<<"WARNING POINT NOT CORRECTLY SET"<<ELog::endDiag;
  //  FixedComp::setConnect(4,Origin+Z*(FC.getLinkPt(8).Z())+
  //			Y*(width/2.0),-Z);
  FixedComp::setLinkSurf(4,getComplementRule("floor")); 
