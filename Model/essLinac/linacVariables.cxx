...
namespace setVariable
{
  ...
  void EssLinacPMQVariables(FuncDataBase&);       // from pmqVariables
  void EssLinacSpokeVariables(FuncDataBase&);           // from SpokeVariables
  ...
  */
{
  ...
  // Faraday cup
  Control.addVariable("LinacFaradayCupActive", 0.0);
  ...
  Control.addVariable("LinacDTL1IntertankLength", 30.49389999999994-1.0);
  ...
  Control.addVariable("LinacDTL5IntertankLength", 0.1); //from optics.mars.tot.COMBINED
  ...
  /*
  // Ducts for Stubs 120,130,140, 150, amd 160
  ...
  Control.addVariable("Stub120Duct1MainMat", "StbTCABL");
  ...
  Control.addVariable("Stub120Duct2MainMat", "StbTCABL");
  ...
  Control.addVariable("Stub170Duct1MainMat", "StbTCABL");
  ...
  Control.addVariable("Stub170Duct2MainMat", "StbTCABL");
  ...
  for(int i=0;i<19;i++){
    char numstr[21];
    sprintf(numstr, "Stub%d", 180+10*i);
    std::string stubDuct1 = std::string(numstr)+"Duct1";
    std::string stubDuct2 = std::string(numstr)+"Duct2";
    std::string stubDuct3 = std::string(numstr)+"Duct3";
    std::string stubDuct4 = std::string(numstr)+"Duct4"; 
  ...
  PipeGen.setPipe(5.0,0.0);
  PipeGen.setWindow(5.0,0.0);
  PipeGen.setFlange(5.0,0.0);
  PipeGen.generatePipe(Control,"LinacBeamPipe",0.0,76.15);
