  ...
  */
{
  ...
  Control.addVariable("LinacFaradayCupShieldBackLength1",170.0);
  Control.addVariable("LinacFaradayCupShieldBackLength2",170.0);
  Control.addVariable("LinacFaradayCupShieldBackLength3",170.0);
