...
DPreMod::DPreMod(const DPreMod& A) : 
  ...
  /*!
    Copy constructor
    \param A :: DPreMod to copy
  */
{}

DPreMod&
DPreMod::operator=(const DPreMod& A)
  /*!
    Assignment operator
    \param A :: DPreMod to copy
    \return *this
...
void
DPreMod::populate(const FuncDataBase& Control)
  /*!
    Populate all the variables
    \param Control :: Function dataase
  */
{
  ELog::RegMethod RegA("DPreMod","populate");
...
void
DPreMod::createSurfaces()
  /*!
    Create All the surfaces
  */
{
  ELog::RegMethod RegA("DPreMod","createSurface");
...
void
DPreMod::createObjects(Simulation& System)
  /*!
    Adds the main components
    \param System :: Simulation to create objects in
  */
{
  ELog::RegMethod RegA("DPreMod","createObjects");
...
void
DPreMod::createAll(Simulation& System,
...
/*!
  ...
  */
{
  ELog::RegMethod RegA("DPreMod","createAll");
