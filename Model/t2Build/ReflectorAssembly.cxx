...
int
ReflectorAssembly::calcModeratorPlanes(const int BeamLine,
  ...
  */
{
  ELog::RegMethod RegA("ReflectorAssembly","calcModeratorPlanes");
...
Geometry::Vec3D
ReflectorAssembly::getViewOrigin(const int BeamLine) const
  /*!
    Given the beamline calculate the defining view and the 
    active surface 
    \param BeamLine :: BeamLine number to use
  ...
  */
{
  ELog::RegMethod RegA("ReflectorAssembly","getViewOrigin");
