 ...
 * File:   essBuildInc/LayeredBulkModule.h
 *
 ...
 *
 ****************************************************************************/
#ifndef essSystem_LayeredBulkModule_h
#define essSystem_LayeredBulkModule_h
...
class LayeredBulkModule : public attachSystem::ContainedComp,
  ...
  public attachSystem::CellMap
{
 ...
 public:
  ...
  LayeredBulkModule(const std::string&);
  LayeredBulkModule(const LayeredBulkModule&);
  LayeredBulkModule& operator=(const LayeredBulkModule&);
  virtual ~LayeredBulkModule();
