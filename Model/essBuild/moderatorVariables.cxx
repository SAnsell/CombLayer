  ...
  */
{
  ...
  Control.addVariable("TopFlyFlowGuideLen1L",3);
  ...
  Control.addVariable("TopFlyFlowGuideLen1Foot",3);
  Control.addVariable("TopFlyFlowGuideDist12",2.0);
  ...
  Control.addVariable("TopFlyFlowGuideLen2Foot",5);
  Control.addVariable("TopFlyFlowGuideDist23",2.0);
  ...
  Control.addVariable("TopFlyFlowGuideDist14",1.0);
  Control.addVariable("TopFlyFlowGuideLen4L",2.0);
  Control.addVariable("TopFlyFlowGuideLen4R",3.5);
