// Usage example:
// povray povray/tomowise.pov
// (it is expected that /tmp/tomowise.sh contains the item to show, e.g. "Line")
...
#fopen STDIN "/tmp/tomowise.txt" read
#read (STDIN, ITEM)
...
#switch ( 0 )
  #case(strcmp(ITEM,"REW"))
    #declare cameraLocation = <1900, 8200, 40>;
    #declare cameraLookAt   = <2100, 8300, 0>;
