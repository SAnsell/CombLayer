 ...
 * - added #include "CellMap.h" and attachSystem::CellMap()
 * 
 *
...
LegoBrick::LegoBrick(const std::string& Key)  :
  ...
  /*!
    This is a Constructor, with 4 geometry item classes from the
...
LegoBrick::populate(const FuncDataBase& Control)
  /*!
    Creates some empty variables and Populates them using the FuncDataBase& with the
    parameter Control
...
LegoBrick::createAll(Simulation& System,
  ...
  /*!
    ...
    \param sideIdex :: this is a link point to the origin; it could be FIndex for Fixed index etc.
  */
{
