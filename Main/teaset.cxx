  ...
  try
    {
      ...
      createTeaSetInputs(IParam);

      SimPtr=createSimulation(IParam,Names,Oname);
      if (!SimPtr) return -1;
      
      setVariable::TeaSetVariables(SimPtr->getDataBase());
      InputModifications(SimPtr,IParam,Names);
        
      teaSetSystem::makeTeaSet teaSetObj;
      World::createOuterObjects(*SimPtr);
      teaSetObj.build(SimPtr,IParam);
