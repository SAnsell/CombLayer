...
#include "pikVariables.h"
#include "DefUnitsPIK.h"
#include "makePIK.h"
  ...
  try
    {
      ...
      setVariable::PIKVariables(SimPtr->getDataBase());

      InputModifications(SimPtr,IParam,Names);
      mainSystem::setMaterialsDataBase(IParam);

      pikSystem::makePIK PIK;
      PIK.build(*SimPtr,IParam);
